...
\section{The Simplified \textit{Q-Law} Alone is Insufficient}
A solar-sail-agnostic formulation of the \textit{Q-Law} is insufficient as a solar sail guidance law on its own. There are two notable problem cases which arise from ignoring solar sail attitude constraints:
\begin{figure}[H]
  \centering
...
\(\varphi^*\) is compared between two cone angle thresholds:
\begin{enumerate}
