...
Quantities related to the guidance law are expressed in the LVLH frame, including steering command outputs. This choice of frame is motivated by past formulations of the \textit{\textit{Q-Law}}, which are based on variational equations in the LVLH frame.
