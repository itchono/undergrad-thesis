\begin{figure}[H]
    ...
    \tdplotsetmaincoords{85}{45}
        ...
        \end{tikzpicture}
        \caption{Nominal operations; $\hat{n}$ is equal to $\hat{n}^*$.}
    ...
    \tdplotsetmaincoords{85}{45}
        ...
        \end{tikzpicture}
        \caption{Degraded operations; $\hat{n}^*$ is projected onto the yellow cone.}
    ...
    \tdplotsetmaincoords{85}{45}
        ...
        \end{tikzpicture}
        \caption{Feathered operations; $\hat{n}$ is normal to $\hat{u}_i$.}
        \label{fig:steering_heuristic_cases_3}
    \end{subfigure}
    \caption{Three different cases of the steering heuristic illustrated.}
